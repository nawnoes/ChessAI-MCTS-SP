...
class Node:
    ...
    def calc_u(self):
        ...
        u = Cpuct * self.policy_Score * (math.sqrt(self.sum_SiblingsN_rollout()+1)/(self.N_rollout+1))
        return u
    def sum_otherN_rollout(self):
        sumAll = self.parent.sum_SiblingsN_rollout()
        return sumAll - self.N_rollout
    def sum_SiblingsN_rollout(self):
